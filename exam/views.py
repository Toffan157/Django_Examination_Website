...
def adminclick_view(request):
    ...
    if request.method=='POST':
        ...
        try:
            ...
            error = "yes"
    return render(request,'exam/adminlogin.html',locals())
...
def update_course_view(request,pk):
    ...
    if request.method=='GET':
        return render(request,'exam/update_courses.html',{'course':course})
    else:
...
def update_question_view(request,pk):
    ...
    if request.method=='GET':
        return render(request,'exam/update_questions.html',{'question':question})
    else:
